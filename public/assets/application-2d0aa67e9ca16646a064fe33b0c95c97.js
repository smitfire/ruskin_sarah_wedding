...
(function() {
  (function() {
     ...
     */
    var DELAY, DURATION, data, drawLineChart, drawPieChart, ready2;
    drawLineChart = function(elementId, data) {
      var area, circleContainer, container, containerEl, detailHeight, detailMargin, detailWidth, drawCircle, drawCircles, height, hideCircleDetails, line, margin, parse, showCircleDetail, startData, svg, tween, width, x, xAxis, xAxisTicks, y, yAxisTicks;
      drawCircle = function(datum, index) {
      ...
      showCircleDetail = function(data) {
        var details, text;
        details = circleContainer.append("g").attr("class", "lineChart--bubble").attr("transform", function() {
          var result;
          result = "translate(";
          result += x(data.date);
          result += ", ";
    ...
    drawPieChart = function(elementId, data) {
      var arc, container, containerEl, detailedInfo, drawChartCenter, drawDetailedInformation, handleAnimationEnd, height, pie, pieChartPieces, pieData, radius, svg, twoPi, width;
      ...
      drawDetailedInformation = function(data, element) {
        ...
        infoContainer.data([data.value * 100]).append("text").text("0 %").attr("class", "pieChart--detail--percentage").attr("x", (position === "left" ? 0 : infoWidth)).attr("y", -10).attr("text-anchor", anchor).transition().duration(DURATION).tween("text", function(d) {
          var i;
          i = d3.interpolateRound(+this.textContent.replace(/\s%/g, ""), d);
          return function(t) {
      ...
      }).each("end", handleAnimationEnd = function(d) {
...
(function() {
  ...
  PieChart = function(css_selector, color_array) {
    var arc, color, height, pie, radius, svg, width;
    width = 480;
    height = 250;
    radius = Math.min(width, height) / 2;
    color = d3.scale.ordinal().range([color_array[0], color_array[1], color_array[2], color_array[3], color_array[4], color_array[5], color_array[6]]);
  ...
  ready = function() {
    var color_one, color_two, pieChart, pieChart2;
    color_one = ["rgba(152,171,197,1)", "rgba(138,137,166,1)", "rgba(123,104,136,1)", "rgba(107,72,107,1)", "rgba(160,93,86,1)", "rgba(208,116,60,1)", "rgba(255,140,0,1)"];
    color_two = ["rgba(107,72,107,1)", "rgba(160,93,86,1)", "rgba(208,116,60,1)", "rgba(152,171,197,1)", "rgba(138,137,166,1)", "rgba(123,104,136,1)", "rgba(255,140,0,1)"];
